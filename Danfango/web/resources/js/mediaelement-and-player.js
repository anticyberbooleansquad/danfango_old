...
mejs.Utility = {
	...
	absolutizeUrl: function(url) {
		...
		el.innerHTML = '<a href="/Danfango/' + this.escapeHTML(url) + '">x</a>';
...
mejs.HtmlMediaElementShim = {
    ...
    if (options.customError) {
      ...
      errorContainer.innerHTML = (poster !== '') ?
        '<a href="/Danfango/' + playback.url + '"><img src="' + poster + '" width="100%" height="100%" /></a>' :
        '<a href="/Danfango/' + playback.url + '"><span>' + mejs.i18n.t('Download File') + '</span></a>';
    }
